...
namespace ConfigMgrWebService
{
    ...
    public class ConfigMgrWebService : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "Get a List of all CMDevices")]
        public List<CMDevice> GetAllCMDevices(string secret)
        {
            MethodBase method = MethodBase.GetCurrentMethod();
            MethodBegin(method);
            ...
            if (secret == secretKey)
            {
                ...
                //' Query for device name
                string query = String.Format("SELECT * FROM SMS_R_System");
                IResultObject result = connection.QueryProcessor.ExecuteQuery(query);
        ...
        public List<CMDevice> GetCMDevicesByName(string secret, string name)
        {
            MethodBase method = MethodBase.GetCurrentMethod();
            MethodBegin(method);
